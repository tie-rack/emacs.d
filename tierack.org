...
(defun color-theme-tierack-light ()
  (color-theme-install
   '(color-theme-tierack
     ...
     (font-lock-string-face ((t (:foreground "#009900"))))
     ...
     (mode-line-buffer-id ((t (:background "#FFFFFF" :foreground "black" :bold t))))
     (mode-line-inactive ((t (:background "#999999" :foreground "black"))))
     (rainbow-delimiters-depth-1-face ((t (:foreground "#000083"))))
     (rainbow-delimiters-depth-2-face ((t (:foreground "#709870"))))
     (rainbow-delimiters-depth-3-face ((t (:foreground "#777766"))))
     (rainbow-delimiters-depth-4-face ((t (:foreground "#6677CC"))))
     (rainbow-delimiters-depth-5-face ((t (:foreground "#907373"))))
     (rainbow-delimiters-depth-6-face ((t (:foreground "#858580"))))
     (rainbow-delimiters-depth-7-face ((t (:foreground "#6276BA"))))

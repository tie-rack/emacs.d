...
(add-to-list 'package-pinned-packages '(suggest . "melpa-stable") t)
#+end_src
...
#+begin_src emacs-lisp
(tierack/require-package 'geiser)
#+end_src
...
(tierack/require-package 'racer)
(tierack/require-package 'toml-mode)
